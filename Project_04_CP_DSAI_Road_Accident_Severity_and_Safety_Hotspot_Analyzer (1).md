...
**Domain:** Road safety and transport analytics  
...
Road accidents need to be analyzed to identify severity drivers and dangerous conditions. Build a system that predicts accident severity and identifies high-risk patterns.

---

## Real-World Impact

Can support road safety planning and targeted interventions.

---

## Problem Statement

Build a working solution for **Road Accident Severity and Safety Hotspot Analyzer** that takes relevant input data, processes it through a clear workflow, and produces an actionable output for real users or decision-makers.
...
Severity classification, hotspot analysis, risk factor explanation.
...
**Dataset / Reference Name:** Road Accidents Severity Dataset

**Link:** https://www.kaggle.com/datasets/kanuriviveknag/road-accidents-severity-dataset

**How to Use It:**
Use accident conditions, road/weather/context variables, and severity labels.
...
Python, Pandas, NumPy, Matplotlib/Seaborn/Plotly, Scikit-learn, optional Streamlit dashboard, GitHub
...
```text
road_accident_severity_and_safety_hotspot_analyzer/
│
├── data/
